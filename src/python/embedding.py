...
class ImageFeedDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Convert to format expected by Vespa.feed_iterable
        return {
...
def send_image_embeddings(app: Vespa, batch, schema=None):
    """
    ...
    app.feed_iterable(batch, schema=schema, callback=callback)
